...
CKEDITOR.lang["fa"] = {
    ...
    "fakeobjects": { "anchor": "لنگر", "hiddenfield": "فیلد پنهان", "iframe": "IFrame", "unknown": "شیء ناشناخته" },
    "forms":
    {
        "button":
        {
    ...
    "specialchar":
        { "options": "گزینه‌های نویسه‌های ویژه", "title": "گزینش نویسه‌ی ویژه", "toolbar": "گنجاندن نویسه‌ی ویژه" },
    "scayt":
    {
