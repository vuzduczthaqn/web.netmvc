...
CKEDITOR.lang["ug"] = {
    ...
    "bidi": { "ltr": "تېكىست يۆنىلىشى سولدىن ئوڭغا", "rtl": "تېكىست يۆنىلىشى ئوڭدىن سولغا" },
    ...
    "font":
    {
        "fontSize": { "label": "چوڭلۇقى", "voiceLabel": "خەت چوڭلۇقى", "panelTitle": "چوڭلۇقى" },
        "label": "خەت نۇسخا",
        "panelTitle": "خەت نۇسخا",
        "voiceLabel": "خەت نۇسخا"
    },
    "fakeobjects":
        { "anchor": "لەڭگەرلىك نۇقتا", "hiddenfield": "يوشۇرۇن دائىرە", "iframe": "IFrame", "unknown": "يوچۇن نەڭ" },
    "forms":
    {
        "button":
        {
        ...
        "hidden": { "title": "يوشۇرۇن دائىرە خاسلىقى", "name": "ئات", "value": "دەسلەپكى قىممىتى" },
        "select":
        {
        ...
        "textarea": { "title": " كۆپ قۇرلۇق تېكىست خاسلىقى", "cols": "ھەرپ كەڭلىكى", "rows": "قۇر سانى" },
        "textfield":
        {
