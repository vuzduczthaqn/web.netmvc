...
CKEDITOR.lang["el"] = {
    ...
    "filetools":
    {
        ...
        "httpError404": "Παρουσιάστηκε σφάλμα HTTP κατά την αποστολή αρχείου (404: Το αρχείο δεν βρέθηκε).",
        "httpError403": "Παρουσιάστηκε σφάλμα HTTP κατά την αποστολή αρχείου (403: Απαγορευμένο).",
        "httpError": "Παρουσιάστηκε σφάλμα HTTP κατά την αποστολή αρχείου (κατάσταση σφάλματος: %1).",
    ...
    {
        "fontSize":
            { "label": "Μέγεθος", "voiceLabel": "Μέγεθος Γραμματοσειράς", "panelTitle": "Μέγεθος Γραμματοσειράς" },
        "label": "Γραμματοσειρά",
        "panelTitle": "Όνομα Γραμματοσειράς",
        "voiceLabel": "Γραμματοσειρά"
    },
    "fakeobjects":
        { "anchor": "Άγκυρα", "hiddenfield": "Κρυφό Πεδίο", "iframe": "IFrame", "unknown": "Άγνωστο Αντικείμενο" },
    "forms":
    {
        "button":
        {
    ...
    "widget": { "move": "Κάνετε κλικ και σύρετε το ποντίκι για να μετακινήστε", "label": "%1 widget" },
    "uploadwidget": {
