...
CKEDITOR.lang["bg"] = {
    ...
    "bidi": { "ltr": "Посока на текста от ляво надясно", "rtl": "Посока на текста от дясно наляво" },
    ...
    "fakeobjects":
        { "anchor": "Кука", "hiddenfield": "Скрито поле", "iframe": "IFrame", "unknown": "Неизвестен обект" },
    "forms":
    {
        "button":
        {
        ...
        "hidden": { "title": "Настройки на скрито поле", "name": "Име", "value": "Стойност" },
        "select":
        {
        ...
        "textarea": { "title": "Настройки на текстова зона", "cols": "Колони", "rows": "Редове" },
        "textfield":
        {
    ...
    "smiley": { "options": "Опции за усмивка", "title": "Вмъкване на усмивка", "toolbar": "Усмивка" },
