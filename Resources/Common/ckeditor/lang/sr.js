...
CKEDITOR.lang["sr"] = {
    ...
    "bidi": { "ltr": "Правац текста са лева на десно", "rtl": "Правац текста са десно на лево" },
    ...
    "fakeobjects":
        { "anchor": "Сидро", "hiddenfield": "Скривено полје", "iframe": "IFrame", "unknown": "Непознат објекат" },
    "forms":
    {
        "button":
        {
        ...
        "textarea": { "title": "Особине зоне текста", "cols": "Број карактера у реду", "rows": "Број редова" },
        "textfield":
        {
    ...
    "smiley": { "options": "Емотикон опције", "title": "Унеси емотикон", "toolbar": "Емотикони" },
